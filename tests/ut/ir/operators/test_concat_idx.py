...
def test_concat_idx_returns_destination_type():
    src0 = _tile("src0", (8, 64), DataType.FP32, (8, 64))
    src1 = _tile("src1", (8, 64), DataType.FP32, (8, 48))
    idx0 = _tile("idx0", (8, 8), DataType.INT32, (8, 1))
    idx1 = _tile("idx1", (8, 8), DataType.INT32, (8, 1))
...
def test_concat_idx_rejects_invalid_index_contract():
    ...
    dst = _tile("dst", (8, 64), DataType.FP32, (8, 64))
    bad_dtype = _tile("bad", (8, 8), DataType.UINT32, (8, 1))
