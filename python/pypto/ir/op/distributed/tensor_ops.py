...
def get(
    ...
    *,
    ...
    view, synthesised VEC staging tile, and TGET. With no offsets/shape this
    reads the full peer source slice into the full local destination slice.
    When offsets and shape are provided it reads
